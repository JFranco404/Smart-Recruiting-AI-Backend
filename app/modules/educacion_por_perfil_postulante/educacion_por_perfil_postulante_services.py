...
from app.modules.educacion_por_perfil_postulante.educacion_por_perfil_postulante_models import FiltrosEducacionPerfilPostulante
...
def obtener_educacion_por_perfil_postulante_por_postulante_id(postulante_id:int, db: Session) -> List[EducacionPorPerfilPostulante]:
    ...
    return db.query(EducacionPorPerfilPostulante).filter(
